...
namespace CapaPresentacion.Superadmin
{
    public partial class Modif_Empleado : Form
    {
        ...
        {
            if (DTGListaEmpleados.SelectedRows.Count == 1)
            {
                DataGridViewRow fila = DTGListaEmpleados.SelectedRows[0];
        ...
        private void Modif_Empleado_Load(object sender, EventArgs e)
        {
            ...
            verEmpleados.verEmpleados(DTGListaEmpleados);
        ...
        {
            EPerfilEmpleado cargarComboBox = new EPerfilEmpleado();
            cargarComboBox.cargarTextBoxPerfil(ComboBox_Perfil);
        }
    }
}
